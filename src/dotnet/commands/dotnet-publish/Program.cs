...
namespace Microsoft.DotNet.Tools.Publish
{
    public partial class PublishCommand
    {
        public static int Run(string[] args)
        {
            ...
            CommandOption profileProjOption = app.Option(
               $"--profile <{LocalizableStrings.ProfileProjOption}>", LocalizableStrings.ProfileProjOptionDescription,
                CommandOptionType.SingleValue);
            ...
            app.OnExecute(() =>
            {
                ...
                publish.ProfileProject = profileProjOption.Value();
